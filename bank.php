...
<div id="mainContainer" class="row large-centered">
  ...
  <dl class="mercDetails">
  	<dt>Merchant</dt> 				<dd>Nepal Bank</dd>
    <dt>Transaction Amount</dt> 	<dd>NRS <?php echo  $_SESSION['amount'];?></dd>
...
<p class="form-subheading">OTP sent to your mobile number ending with <strong>65</strong></p>
